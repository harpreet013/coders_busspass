...
Start_Date, End_Date,Cost, Profile_Image FROM add_pass1 WHERE Pass_Number='$passnumber'";
...
if (mysqli_num_rows($result)>0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo "Phone : " . $row["Phone"]. " - Email : " . $row["Email"]. " -Gender : " . $row["Fname"]. "<br>";
    echo "Caterogy : " . $row["Category"]. " - Identity_Type : " . $row["Identity_Type"]. " -Source " . $row["Source"]. "<br>";
    echo "Destination : " . $row["Id"]. " - Start_Date : " . $row["Start_Date"]. " -End_Date :" . $row["End_Date"]. "<br>";
    echo "Cost : " . $row["Id"]. " - Image: " . $row["Profile_Image"]."<br>";
  }
} else {
  echo "0 results";
}
